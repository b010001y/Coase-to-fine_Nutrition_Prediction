...
def main():
    img_file = os.path.join('../nutrition5k_dataset/imagery/realsense_overhead')
    img_list = os.listdir('../nutrition5k_dataset/imagery/realsense_overhead')
    for i in img_list:
        if i == 'frames' or i == 'frames_sampled':
            pass
        else:
            iimg_list = os.listdir(os.path.join(img_file, i))
            img_name = os.path.join('../nutrition5k_dataset/imagery/new_realsense_overhead', i)
